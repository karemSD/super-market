				...
				<div class="page-header">
					...
					<ol class="breadcrumb">
						<li class="breadcrumb-item">
                            ...
                            <li class="breadcrumb-item breadcrumb-active" aria-current="page">Add Category</li>
					</ol>
					<!-- Breadcrumb end -->
                    ...
                    <div class="col-sm-6 col-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-12">
                                            <div class="mb-0">
                                                ...
                                                <textarea rows="4" class="form-control" name="description" placeholder="Enter Category Description"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-12">
                                            <label class="form-label m-1">Category Image <span class="text-red">*</span></label>
                        ...
                        <div class="col-sm-12 col-12">
                            <div class="custom-btn-group flex-end">
                                ...
                                <button class="btn btn-primary" type="submit">Add Cateogry </button>
                            </div>
                    </div>
                </div>
            </form>
