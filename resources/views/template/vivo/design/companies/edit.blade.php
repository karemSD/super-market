				...
				<div class="page-header">
					...
					<ol class="breadcrumb">
						<li class="breadcrumb-item">
                            ...
                            <li class="breadcrumb-item breadcrumb-active" aria-current="page">Update  Market</li>
					</ol>
					<!-- Breadcrumb end -->
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card-border">
                            ...
                            <div class="card-border-body">
                                <form action="{{ route('company.update', ['company' => $company->id]) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"  value="{{ $company->name }}"  name="name" class="form-control" placeholder="Enter Company Name" required>
                                            </div>
                                        </div>
...
<select name="category_id" class="form-select" aria-label="Default select example" required>
            <option value="{{ $company->category_id }}" selected disabled>{{ $company->category->name }} (Read-only)</option>
                ...
                <div class="col-sm-12 col-12">
                    ...
                    <input type="text" class="form-control" readonly value="{{ $company->image_url }}">
                </div>
                                        <div class="col-sm-12 col-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="">
                                                        <label for="form-label m-1">New Company Image (Optional)</label>
                                    ...
                                    <div class="custom-btn-group flex-end">
                                        <a  href="{{route('category.show' , ['category' => $company->category->id ])}}" class="btn btn-light">Cancel</a>
